...
enum SiI_RX_Path {
    ...
    SiI_RX_P_YCbCr422,               // This mode is used with digital output only
    SiI_RX_P_YCbCr422_MUX8B,         // YCbCr 422 muxed 8 bit, used with digital output only
    SiI_RX_P_YCbCr422_MUX10B,        // YCbCr 422 muxed 10 bit, used with digital output only
...
enum SiI_RX_Path_Switch {
    ...
    SiI_RX_P_S_PassReplicatedPixels = 0x80, // For video modes with pixel replication rate Output wont be
                                            // divided
};
...
enum SiI_RX_GlobalStatus {
    ...
    SiI_RX_GlobalHDMI_ACP = 0x10, // VG On this event upper layer should disable multi-channel digital output
...
enum SiI_RX_VideoState {
    ...
    SiI_RX_VS_ReqGlobalPowerDown,  //  it's need to accomplish some job (like Soft Audio Mute
...
enum SiI_ErrWrnCode {
    ...
    SiI_WC_IncorrectCombPrm, // W004: Incorrect combination of input parameters
...
// Video Errors
    SiI_EC_InColorSpace = 0x88,     // E008: Wrong parameter of Input Color Space
...
enum SiI_AudioErrCode {
    ...
    SiI_EC_CTS_Dropped = 0x8B,      // E011 CTS Dropped (packets coming too fast)
    SiI_EC_CTS_Reuseed = 0x8C,      // E012 CTS Reused  (packets coming too slow)
