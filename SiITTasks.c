...
// Function Description:  This function clears BCH Errors, Polls HDMI Cable Status and calls ReInit RX on
//                        HDMI Cable Plug In Event
//------------------------------------------------------------------------------
...
//YMA set the terminaion to 3k ohm first and then after HPD, change it back to normal
		if ( SiI_Ctrl.bDevId == RX_SiI9135 || SiI_Ctrl.bDevId ==  RX_SiI9125){//YMA others use default
