...
#define RX_BLANKDATA_CH0_ADDR 0x4B   // Defines the video blanking value for channel 0
#define RX_BLANKDATA_CH1_ADDR 0x4C   // Defines the video blanking value for channel 1
#define RX_BLANKDATA_CH2_ADDR 0x4D   // Defines the video blanking value for channel 2
