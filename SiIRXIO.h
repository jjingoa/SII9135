...
// HDMI Receiver
#define siiIIC_RX_RWBitsInByteP0( ADDR, DATA, OP )  siiModifyBits( RX_SLV0, ADDR, DATA, OP)
#define siiIIC_RX_RWBitsInByteP1( ADDR, DATA, OP )  siiModifyBits( RX_SLV1, ADDR, DATA, OP)
...
// Analog Front End
#define siiIIC_RX_RWBitsInByteU0( ADDR, DATA, OP )  siiModifyBits( RX_AFE0, ADDR, DATA, OP)
#define siiIIC_RX_RWBitsInByteU1( ADDR, DATA, OP )  siiModifyBits( RX_AFE1, ADDR, DATA, OP)
...
#define siiIIC_RX_RMW_ByteP0( ADDR, MASK, VAL )	siiReadModWriteByte( RX_SLV0, ADDR, MASK, VAL)
#define siiIIC_RX_RWW_ByteP1( ADDR, MASK, VAL )	siiReadModWriteByte( RX_SLV1, ADDR, MASK, VAL)
