...
//
// Module Description:  this low level driver for reading/writing Atmel AT89C51ID2 EEPROM
//
...
// Function Description:  This function reads one byte of Internal EEPROM of AT89C51ID2
//                        Internal EEPROM uses XDATA adressing of 8051, when EEPROM XDATA is selected
//                        RAM XDATA is not accessible. Input parameters are should be
//                        converted to DATA segment before switching to EEPROM XDATA segment
...
// Function Description:  This function writes one byte of Internal EEPROM of AT89C51ID2
//                        Internal EEPROM uses XDATA adressing of 8051, when EEPROM XDATA is selected
//                        RAM XDATA is not accessible. Input parameters are should be
//                        converted to DATA segment before switching to EEPROM XDATA segment
// Accepts: wAddr, address of EEPROM location
